...
public class GameManager : MonoBehaviour {
    ...
    [Tooltip("Enable/disable post-processing effects")]
    public bool enablePostProcessing = true;
    [Tooltip("Enable/disable shadows")]
    public bool enableShadows = true;
    [Tooltip("Enable/disable anti-aliasing")]
    ...
    [Tooltip("Enable/disable grain effect")]
    ...
    // Configure graphics settings
    void ConfigureGraphicsSettings()
    {
        ...
        {
            // Note: These settings require the Post Processing Stack v2 package
            // You'll need to add the package and configure the post-processing volume
            // in your scene with these effects enabled/disabled based on the settings
        }
    }
